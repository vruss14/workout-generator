  ...
  return (
      <main id="main-beginner-container" style={animate ? beginnerPageAnimated : beginnerPage}>
          <div id="beginner-top-div" className="has-background-light">
            ...
            <p className="has-text-centered ml-3 mr-3 pl-3 pr-3 page-descr" id="page-description">*Please select at least five exercises to ensure your workout has enough variety.</p>
          </div>
